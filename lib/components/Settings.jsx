		...
		return (
			<TransitionAppear duration={250}>
				<div data-component='Settings'>
					<h1>Thiết lập kết nối SIP</h1>

					<div className='item'>
						<TextField
							floatingLabelText='Địa chỉ SIP URI'
							value={settings.uri || ''}
							floatingLabelFixed
							fullWidth
					...
					<div className='item'>
						<TextField
							floatingLabelText='Mật khẩu SIP'
					...
					<div className='item'>
						<TextField
							floatingLabelText='Địa chỉ WebSocket URI'
