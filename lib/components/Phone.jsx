...
export default class Phone extends React.Component
{
					...
					<header>
						<div className='topbar'>
							...
							>
								...
								>
									<MenuItem
										primaryText='Sao chép đường dẫn Website'
									/>
								</CopyToClipboard>
								...
								>
									<MenuItem
										primaryText='Sao chép địa chỉ SIP URI'
									/>
								</CopyToClipboard>
								<MenuItem
									primaryText='Thoát'
	...
	componentDidMount()
	{
		...
		catch (error)
		{
			this.props.onNotify(
				{
					level   : 'error',
					title   : 'Cấu hình SIP không chính xác.',
		...
		this._ua.on('newRTCSession', (data) =>
		{
			...
			if (state.session || state.incomingSession) {
				...
				session.terminate(
					{
						status_code   : 486,
						reason_phrase : 'Người dùng đang bận'
					});
	...
	handleMenuCopyUri()
	{
		...
		let message = 'Đã copy địa chỉ SIP vào clipboard';
